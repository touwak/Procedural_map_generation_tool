...
public class HexGridChunk : MonoBehaviour {
  ...
  void TriangulateCornerTerracesCliff(Vector3 begin, HexCell beginCell,
    ...
    TriangulateBoundaryTriangle(begin, beginCell, left,
      leftCell, boundary, boundaryColor);

    if (leftCell.GetEdgeType(rightCell) == HexEdgeType.Slope) {
      TriangulateBoundaryTriangle(left, leftCell, right,
        rightCell, boundary, boundaryColor);
    }
    else {
  ...
  Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell) {
    ...
    TriangulateBoundaryTriangle(right, rightCell, begin,
      beginCell, boundary, boundaryColor);
